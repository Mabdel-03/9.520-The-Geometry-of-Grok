#!/bin/bash
# Master script to submit all Composition Reasoning experiments
# Tests all optimizer/weight_decay combinations

echo "Submitting all Composition Reasoning experiments..."

# Create logs directory
mkdir -p logs

# Define weight decay values to test (Wang paper used 0.1)
...
for optimizer in "${OPTIMIZERS[@]}"; do
    for wd in "${WEIGHT_DECAYS[@]}"; do
        ...
        sbatch run_composition_single.sh $optimizer $wd

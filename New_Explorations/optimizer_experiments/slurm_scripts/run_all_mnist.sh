#!/bin/bash
# Master script to submit all MNIST Omnigrok experiments
# Tests all optimizer/weight_decay combinations

echo "Submitting all MNIST Omnigrok experiments..."

# Create logs directory
mkdir -p logs

# Define weight decay values to test
WEIGHT_DECAYS=(0.0 0.001 0.01 0.1 0.5 1.0)
...
for optimizer in "${OPTIMIZERS[@]}"; do
    for wd in "${WEIGHT_DECAYS[@]}"; do
        ...
        sbatch run_mnist_single.sh $optimizer $wd

#!/bin/bash
#SBATCH --job-name=cubic_agop
#SBATCH --output=/om2/user/mabdel03/files/Classes/9.520/9.520-The-Geometry-of-Grok/New_Explorations/ICML_Submission/Power_AGOP_Study/slurm_scripts/logs/cubic_agop_%A_%a.out
#SBATCH --error=/om2/user/mabdel03/files/Classes/9.520/9.520-The-Geometry-of-Grok/New_Explorations/ICML_Submission/Power_AGOP_Study/slurm_scripts/logs/cubic_agop_%A_%a.err
#SBATCH --array=0-47
...
# ============================================================================
# Cubic Polynomial AGOP Study Experiment Sweep
# ============================================================================
#
# Task: f(x, y) = (x³ + xy) mod 97
#
# This is a more complex polynomial operation that is hypothesized to NOT
# exhibit grokking. The purpose is to study AGOP behavior when generalization
# fails to occur.
#
...
echo "============================================================================"
echo "Cubic Polynomial AGOP Study Experiment"
echo "============================================================================"
echo "Task: f(x, y) = (x³ + xy) mod 97"
echo ""
...
# Run training with cubic operation
$CONDA_ENV/bin/python ${BASE_DIR}/training_scripts/train_power_agop.py \
    ...
    --device cuda \
    --seed 42 \
    --save_dir ${BASE_DIR}/results_cubic

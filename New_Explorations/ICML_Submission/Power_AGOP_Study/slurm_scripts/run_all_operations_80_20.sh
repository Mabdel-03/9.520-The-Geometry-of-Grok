#!/bin/bash
#SBATCH --job-name=agop_all_80
#SBATCH --output=/om2/user/mabdel03/files/Classes/9.520/9.520-The-Geometry-of-Grok/New_Explorations/ICML_Submission/Power_AGOP_Study/slurm_scripts/logs/agop_all_80_%A_%a.out
#SBATCH --error=/om2/user/mabdel03/files/Classes/9.520/9.520-The-Geometry-of-Grok/New_Explorations/ICML_Submission/Power_AGOP_Study/slurm_scripts/logs/agop_all_80_%A_%a.err
#SBATCH --array=0-431
...
# ============================================================================
# All Operations AGOP Study - 80/20 Train/Test Split
# ============================================================================
#
# Runs all 9 modular arithmetic operations with 80/20 train/test split:
#   - add: x + y
#   - sub: x - y
#   - mul: x * y
#   - div: x / y
...
RESULT_DIR="${BASE_DIR}/results_${OPERATION}_80"

echo "============================================================================"
echo "All Operations AGOP Study - 80/20 Split"
echo "============================================================================"

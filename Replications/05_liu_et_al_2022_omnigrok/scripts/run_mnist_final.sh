#!/bin/bash
#SBATCH --job-name=paper05_mnist_final
#SBATCH --output=../results/logs/mnist_final_%j.out
#SBATCH --error=../results/logs/mnist_final_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=16G
...
echo "==========================================
"
echo "Paper 05: Omnigrok - MNIST (FINAL - AdamW)"
echo "=========================================="
echo "Working directory: $(pwd)"
echo "Training 1000 MNIST samples with AdamW optimizer"
echo "Expected: 100% train, ~89% test with grokking"
echo ""
